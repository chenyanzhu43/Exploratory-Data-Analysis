...
![ ](/Users/yanzhuchen/Desktop/lyrics.jpg)
...
load("/Users/yanzhuchen/Desktop/lyrics.RData")
```
...
```{r cleaned dt_lyrics, warning=FALSE, message=FALSE}
...
write_csv(dt_lyrics, "/Users/yanzhuchen/Desktop/processed_lyrics.csv")
```
...
#load dataset
lyrics <- read_csv('/Users/yanzhuchen/Desktop/processed_lyrics.csv')
```

When hear a song, the melody is always the first impression we have on it. For different genres of songs, the melodies seem to be quite distinct. While I'm curious about words variability of lyrics. Is the lyrics as changebale as melody, or on the opposite, immutable in core significant level? 

I tried to answer this question in general and in timeline from the given collection of song lyrics.
...
![ ](/Users/yanzhuchen/Desktop/love.jpg)
